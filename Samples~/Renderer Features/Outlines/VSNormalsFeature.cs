...
public class VSNormalsFeature : ScriptableRendererFeature
{
    class Pass : ScriptableRenderPass
    {
        ...
        public Pass(Material material)
        {
            ...
            destinationHandle.Init("_VSNormalsTexture");
        }
    ...
    {
        Material material = new Material(Shader.Find("Shader Graphs/ViewSpaceNormalsShader"));
